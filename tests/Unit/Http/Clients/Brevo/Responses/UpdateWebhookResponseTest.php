...
class UpdateWebhookResponseTest extends TestCase
{
    /** @test */
    public function from_response()
    {
        ...
        $response = UpdateWebhookResponse::fromResponse($clientResponse);
    ...
    {
        $this->assertContains(HasStatus::class, class_uses(UpdateWebhookResponse::class));
    }
}
